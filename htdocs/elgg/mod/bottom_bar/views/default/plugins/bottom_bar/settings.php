...
<table>
  ...
  <tr><td>&nbsp;</td></tr>
  <tr>
    <td><?php echo elgg_echo('bbar:admin:allowsounds'); ?></td>
    <td>&nbsp;</td>
    <td>
      <select name="params[allow_sounds]">
        <option value="true" <?php if (!$vars['entity']->allow_sounds || $vars['entity']->allow_sounds == "true") echo "selected=\"yes\" "; ?>><?php echo elgg_echo('option:yes'); ?></option>
        <option value="false" <?php if ($vars['entity']->allow_sounds == "false") echo "selected=\"yes\" "; ?>><?php echo elgg_echo('option:no'); ?></option>
      </select>
    </td>
  </tr>
</table>
...
<table>
  <tr>
	...
	<option value="ELGG" <?php if (!$vars['entity']->database_type || $vars['entity']->database_type == "ELGG") echo "selected=\"yes\" "; ?>>ELGG Objects</option>
...
-->
  ...
  <tr><td>&nbsp;</td></tr>
  <tr><td><?php echo elgg_echo('bbar:admin:dbmysqlhost'); ?></td><td> <?php echo elgg_view('input/text',array('internalname'=>'params[database_host]','value'=>elgg_get_plugin_setting('database_host', 'bottom_bar'))); ?></td></tr>
  <tr><td>&nbsp;</td></tr>
  <tr><td><?php echo elgg_echo('bbar:admin:dbmysqluser'); ?></td><td> <?php echo elgg_view('input/text',array('internalname'=>'params[database_username]','value'=>elgg_get_plugin_setting('database_username', 'bottom_bar'))); ?></td></tr>
  <tr><td>&nbsp;</td></tr>
  <tr><td><?php echo elgg_echo('bbar:admin:dbmysqlpass'); ?></td><td> <?php echo elgg_view('input/password',array('internalname'=>'params[database_password]','value'=>elgg_get_plugin_setting('database_password', 'bottom_bar'))); ?></td></tr>
  <tr><td>&nbsp;</td></tr>
  <tr><td><?php echo elgg_echo('bbar:admin:dbmysqldbase'); ?></td><td> <?php echo elgg_view('input/text',array('internalname'=>'params[database_dbname]','value'=>elgg_get_plugin_setting('database_dbname', 'bottom_bar'))); ?></td></tr>
  <tr><td>&nbsp;</td></tr>
  <tr><td><?php echo elgg_echo('bbar:admin:dbmysqlprefix'); ?></td><td> <?php echo elgg_view('input/text',array('internalname'=>'params[database_prefix]','value'=>elgg_get_plugin_setting('database_prefix', 'bottom_bar'))); ?></td></tr>
</table>
